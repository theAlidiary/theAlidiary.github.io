...
This is my first blog. And I hope it would be of great interest to those, who are planning to write their dissertations or for anyone aiming to analyze statistics such as socioeconomic development etc. within or across the countries. In this regard, the [World Development Indicators (WDI)](http://datatopics.worldbank.org/world-development-indicators/), which is one of the leading open data source, from the [World Bank](http://www.worldbank.org/). It offers statistics on more than 1500 indicators, ranging from 1960 to the latest date, and covering around 200 plus countries. Still, for majority of investigators, it is such a daunting process to download data, then clean it and make it ready for the question to be answered. 
...
```{r chunk1, echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
library(WDI)
...
```{r chunk2,echo=TRUE,fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk3,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk4,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk5,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk6,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk7,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk8, echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}

p <- ggplot(data = filter(plotdata,expenditures=="Military_expenditure"), 
...
```{r chunk9,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
...
```{r chunk10,echo=TRUE, fig.align='center', fig.height=6, fig.width=12, warning=FALSE, dpi=400}
